...
//----------------------------------------------------------------------------//
import { throwError, ValueIsFiniteNumber, ValueIsString, ValueIsNonEmptyString, ValueIsFunction, ValueIsPlainObject, ValueIsOneOf, allowedFiniteNumber, allowedIntegerInRange, allowedString, allowedNonEmptyString, allowPlainObject, allowedPlainObject, allowListSatisfying, allowedFunction, ObjectIsNotEmpty, quoted, constrained } from 'javascript-interface-library';
...
export function asDraggable(Element, Options) {
    var isDragged;
...
//-------------------------------------------------------------------------------
export var DropOperations = ['copy', 'move', 'link'];
...
export function asDroppable(Element, Options) {
    var isDragged;
    var currentDraggableOptions;
...
export function asDropZone(Element, Options) {
