...
* can mimic *real* dragging of an element (and not just a "ghost image" while the original stands still, see many examples, f.e. [this one](https://svelte.dev/repl/601fe6818bdc48f487002c489024c0a8))
