...
* can mimic *real* dragging of an element (and not just of a "ghost image" while the original stands still, see many examples, f.e. [this one](https://svelte.dev/repl/6e98523988f54335bf2e2307e79b4173))
...
* [holding over a drop zone](https://svelte.dev/repl/e1c6ee3a5b10464585d86cec61cccab4) - detects when a dragged element stands still for a while (i.e., is "held") over a drop zone
