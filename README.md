...
* `type DragDummy = (`<br>&nbsp; `string | HTMLElement | SVGElement | ((DraggableExtras:any) => HTMLElement | SVGElement) | 'standard' | 'none'`<br>`)`<br>a `DragDummy` specifies which drag image will be shown during dragging (see below for details)
